...
Revision ID: 100952249cee
Revises: 374e02a5046a
Create Date: 2021-08-21 18:02:04.648004
...
revision = '100952249cee'
down_revision = '374e02a5046a'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    with op.batch_alter_table('question', schema=None) as batch_op:
        batch_op.add_column(sa.Column('user_id', sa.Integer(), nullable=True, sever_default='1'))
