...
from app.models import Question, Answer, User, question_voter
...
def _list():
    ...
    if kw:
        ...
        question_list = question_list \
            .join(User).outerjoin(sub_query, sub_query.c.question_id == Question.id).filter(Question.subject.ilike(search) |  # 질문제목
...
@bp.route('/detail/<int:question_id>/') # 질문 상세 화면
